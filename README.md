...
```bash
git clone https://github.com/en0f/BugTrace-AI.git && cd BugTrace-AI && chmod +x dockerizer.sh && sudo ./dockerizer.sh
```

Clone the repository:

```bash
git clone https://github.com/enof/BugTrace-AI.git
cd BugTrace-AI
```
